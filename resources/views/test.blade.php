    ...
    <div class="wrapper">
        ...
        <div class="main main-raised">
            ...
            <div class="section section-notifications" id="notifications">
                ...
                <div class="alert alert-warning">
                    <div class="container-fluid">
                        ...
                        <b>Warning Alert:</b> Hey, it looks like you still have the "copyright &copy; 2015" in your footer.
                        Please update it!
                    </div>
                </div>
                    ...
                    <div id="images">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-sm-offset-1">
                                ...
                                <img src="assets/img/avatar.jpg" alt="Raised Image"
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            ...
                            <h4>The kit comes with three pre-built pages to help you get started faster. You can change the
                                text and images and you're good to go. More importantly, looking at them will give you a
            ...
            <div class="col-md-12 text-center">
                <a href="examples/signup-page.html" class="btn btn-simple btn-primary btn-lg" target="_blank">View Signup
                    Page</a>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="examples/landing-page.html" target="_blank">
                                <img src="assets/img/landing.jpg" alt="Rounded Image"
                        ...
                        <div class="col-md-6">
                            <a href="examples/profile-page.html" target="_blank">
                                <img src="assets/img/profile.jpg" alt="Rounded Image"
                                     class="img-rounded img-raised img-responsive">
                ...
                <div class="container">
                    <div class="row text-center">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <h4>Cause if you do, it can be yours for FREE. Hit the button below to navigate to Creative Tim
                                where you can find the kit. Start a new project or give an old Bootstrap project a new
                                look!</h4>
                        </div>
                    ...
                    <div class="row text-center">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <h4>We've just launched <a
                                        ...
                                        target="_blank">Material Kit PRO</a>. It has a huge number of components, sections
                                and example pages. Start Your Development With A Badass Bootstrap UI Kit inspired by
                                Material Design.</h4>
                        </div>
                        <div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-4">
                            <a href="http://demos.creative-tim.com/material-kit-pro/presentation.html?ref=utp-freebie"
                               class="btn btn-upgrade btn-lg" target="_blank">
                                <i class="material-icons">unarchive</i> Upgrade to PRO
                            </a>
                        </div>
                    </div>
